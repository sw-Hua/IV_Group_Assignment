...
function get_colors (n) {
    ...
    var svg = d3.select("#stack-area-container-main-country").append("svg")
      ...
      svg.append("text")
        ...
        d3.csv("Imports _Of_Services_ By_ Major_Trading_Partner2000_2021_mainCountry.csv", function(error, data) {
